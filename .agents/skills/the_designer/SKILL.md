...
2. **HTMX Integration**: Design user flows that leverage Hypermedia as the Engine of Application State (HATEOAS). Plan out how fragments will swap into the DOM cleanly and effectively without breaking the page structure.
